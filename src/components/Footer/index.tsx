...
const Footer: React.FunctionComponent<IFooterProps> = () => {
  ...
  return (
    <div>
      <Layout>
        <Footer className="flex flex-col items-center bg-blue-gray-700 text-white text-center text-surface">
          <div className="pt-4">
            <div className="flex items-center justify-center space-x-4">
              ...
              <Link to="https://www.github.com/mhaiql/" target="_blank">
                <a
                  type="button"
                  className="rounded-full bg-transparent p-3 font-medium uppercase leading-normal text-surface transition duration-150 ease-in-out hover:bg-neutral-100 focus:outline-none focus:ring-0 dark:text-white dark:hover:bg-secondary-900"
                  data-twe-ripple-init
          ...
          <div className="w-full pb-4 text-center text-blue-gray-100">
            Muhammad haiqal ©{new Date().getFullYear()}
          </div>
        </Footer>
      </Layout>
    </div>
